...
@FindBy(xpath="//*[@id=\"info_panel\"]/div[1]/div/a[1]")WebElement direction_tab;
...
public void direction() throws InterruptedException
{
	...
	try
	{
	wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"info_panel\"]/div[1]/div/a[1]")));
	direction_tab.click();
	...
	Thread.sleep(2000);
	WebElement value1=driver.findElement(By.xpath("//div[@id='fastest_turn_0']"));
